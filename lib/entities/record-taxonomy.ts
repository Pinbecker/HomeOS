...
export const ENTITY_KIND_LABELS: Record<RecordCategory, string> = {
  identity: 'Person',
  home: 'Home thing',
  utility: 'Utility',
  insurance: 'Cover',
...
export const ENTITY_GROUPS: Array<{
  key: string
  title: string
  subtitle: string
...
}> = [
  {
    key: 'home',
    title: 'Home & Property',
    subtitle: 'The house, appliances and useful reference',
    categories: ['home', 'reference'],
  },
  {
    key: 'people',
    title: 'People & Pets',
    subtitle: 'The humans, pets and important contacts',
    categories: ['identity', 'pet', 'contact'],
  },
  {
    key: 'services',
    title: 'Utilities & Services',
    subtitle: 'Bills, providers and recurring household services',
    categories: ['utility', 'subscription'],
  },
  {
    key: 'cover',
    title: 'Cover & Vehicles',
    subtitle: 'Policies, vehicles, renewals and proof',
