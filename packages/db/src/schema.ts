...
export const reminders = sqliteTable('reminders', {
  ...
  kind: text('kind', { enum: ['general', 'renewal', 'expiry', 'maintenance', 'payment', 'follow_up'] }).notNull().default('general'),
  dueAt: integer('due_at', { mode: 'timestamp' }),
  leadDays: integer('lead_days'),
  repeatInterval: text('repeat_interval', { enum: ['monthly', 'quarterly', 'yearly'] }),
